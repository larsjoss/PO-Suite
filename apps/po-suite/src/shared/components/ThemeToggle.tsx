...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex items-center justify-center w-8 h-8 rounded-md text-ink-secondary hover:text-ink hover:bg-edge-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand"
    >
