...
import { Button, EmptyState, LoadingSkeleton, MarkdownOutput, PanelHeader } from '../../shared/components';
      ...
      >
        ...
        {!isLoading && !hasOutput && (
          <EmptyState
            ...
            description="Dein aufbereiteter Text erscheint hier nach der Generierung."
          />
        )}
